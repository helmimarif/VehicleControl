local isInVehicleControl = false
...
RegisterCommand("vehiclecontrol", function(source, args, rawCommand)
	if IsPedInAnyVehicle(PlayerPedId(), false) and not IsPauseMenuActive() then
		openVehicleControl()
	end
end, false)

RegisterKeyMapping('vehiclecontrol', 'Open Vehicle Menu', 'keyboard', DefaultOpen)
...
RegisterNetEvent('vehiclecontrol:openExternal')
AddEventHandler('vehiclecontrol:openExternal', function()
	if IsPedInAnyVehicle(PlayerPedId(), false) then
		openVehicleControl()
	end
end)
...
function closeVehicleControl()
	isInVehicleControl = false
...
RegisterCommand("vehiclecontrolclose", function(source, args, rawCommand)
	closeVehicleControl()
end, false)
